export default function Mission() {
    return (
        <div>
            ...
            <p className="pb-4">
                ENVISION Research Competition is an annual international research competition for female and genderqueer high school students interested in STEM. 
                Students work individually or in groups of up to 4 members to write a formal research proposal. 
            ...
            <div className="flex flex-row lg:px-8 py-4 space-x-4">
                ...
                <div>
                    <p className="text-xl font-bold pb-2">
                        ENVISION transforms high school research
                    </p>
                    <p>
            ...
            <div className="flex flex-row lg:px-8 py-4 space-x-4">
                ...
                <div>
                    <p className="text-xl font-bold pb-2">
                        ENVISION encourages innovation without limits
                    </p>
                    <p>
            ...
            <div className="flex flex-row lg:px-8 pt-4 space-x-4">
                <div className='relative w-8'>
                    <div className='font-extrabold w-8 h-8 border-3 border-purple text-purple bg-transparent flex items-center justify-center rounded-full'>
                        <p>3</p>
                    </div>
                ...
                <div>
                    <p className="text-xl font-bold pb-2">
                        ENVISION teaches proposal writing
                    </p>
